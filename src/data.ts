...
export const DESKTOP_ICONS = [
  ...
  { id: 'browser',      label: 'BROWSER.net',   icon: null, emoji: '🌍',  lucide: 'Globe' },
  { id: 'gallery',      label: 'GALLERY.photos',icon: null, emoji: '🖼️',  lucide: 'Image' },
  { id: 'videoplayer',  label: 'MEDIA.video',   icon: null, emoji: '🎬',  lucide: 'Video' },
  { id: 'music-player', label: 'MUSIC.mp3',     icon: null, emoji: '🎵',  lucide: 'Music' },
  { id: 'games',        label: 'GAMES.exe',     icon: null, emoji: '🎮',  lucide: 'Gamepad2' },
  { id: 'file-explorer',label: 'EXPLORER.exe',  icon: null, emoji: '📂',  lucide: 'Folder' },
  { id: 'paint',        label: 'PAINT.art',     icon: null, emoji: '🎨',  lucide: 'Palette' },
